...
Lines: number,
  ...
  return { Date, Time, Email, Lines,  };
}

const rows: TableRow[] = [
  TableData("2-3- 2022","1:05am", "mamagre@gmail.com", 21 , ),
  TableData("2 -3- 2022", "`1:03am","amamaam@gmal.com",23,),
];

const SheetLog: React.FC = () => {
  return (
        ...
        <tbody className="cursor-pointer">
          {rows.map((row) => (
            ...
            >
              ...
              <td className="border-t border-gray-100 py-4 text-left text-purple-500 font-Poppins text-sm font-normal px-3 flex item-center">
                <span className="ml-2">
                  <img src={folder} alt="" />
                </span>
