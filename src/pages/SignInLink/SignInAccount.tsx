...
const rows: TableRow[] = [
  ...
  TableData("2/8/2022","01:50am", "ha@gmail.com", "Job Application","SIN0394035", "Pause"),
  TableData(
    "2/6/2022","01:51am",
    "123bg@gmail.com",
    "Good Manufacturing",
  ...
  TableData("2/3/2022","01:51am", "wee@gmail.com", "Good","SIN0394035", "Delete"),
];
          ...
          <div className="border-radius-[0.9375rem] bg-white  h-auto  overflow-hidden font-Poppins">
            <div className="bg-secondaryColor flex justify-between  px-4 py-4 rounded-t-lg">
                ...
                <div className="flex  gap-7 ">
                    <Link
                      to="/SignInAccount/tab"
                      className={`${
                        location.pathname === "/SignInAccount/tab"
                    ...
                    <Link
                      to="/SignInAccount/tabtwo"
                      className={`${
                        location.pathname === "/SignInAccount/tabtwo"
                          ? "border-b-2 border-black "
                          : "text-gray-500"
                      }`}
                    >
